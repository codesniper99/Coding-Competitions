     ...
     for(ll i=0;i<n;i++)
     {
         ...
         if(directions[i]==1)
         {
            ...
            // coordinates of car. left and right at any time
             ...
             double left_coordinate =(positions[i]-lengths[i])+velocities[i]*(total_time)+comp;
             double right_coordinate =(positions[i]          )+velocities[i]*(total_time)+comp;
         ...
         else if(directions[i]==0)
         {
             ...
             double left_coordinate =(positions[i])-(velocities[i]*total_time)-comp;
             double right_coordinate =(positions[i]+lengths[i])-(velocities[i]*total_time)-comp;
